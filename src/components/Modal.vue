    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <div>
            <button type="submit" @click="cancel" class="btn btn-outline-danger btn-sm">取消</button>
            <button type="submit" @click="updateData" class="btn btn-outline-primary btn-sm">送出</button>
          </div>
        </div>
      </div>
    </div>
